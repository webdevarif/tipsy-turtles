...
const Faq = () => {
    ...
    const data = [
        ...
        {
            "question": "IP?",
            "answer": "<p>Once you hold the CNFT, you are free to use the Tipsy Turtles IP for personal & even commercial purposes. More on that here: <a href='#'>terms & conditions.</a></p>"
        },
        {
            "question": "Policy ID?",
        ...
        {
            "question": "Learn More?",
            "answer": "<p>We’ll be updating the Tipsy Turtles website periodically. Until then, <a href='#'>Twitter</a> & <a href='https://discord.gg/wgstwPmz'>Discord</a> are your friends, anon! </p>"
        }
    ]
